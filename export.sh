#!/bin/bash
sudo echo "export TRAKT_USERNAME=lavaeater" >> /etc/profile
sudo echo "export TRAKT_ACCOUNT=lavaeater" >> /etc/profile
sudo echo "export MEDIA_PATH=/media/pi/media" >> /etc/profile
